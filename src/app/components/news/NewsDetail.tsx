          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-4">
            ...
            <div className="self-stretch inline-flex justify-between items-center sm:flex-row flex-col gap-4 sm:gap-0">
              <div className="flex justify-start items-center gap-4 flex-wrap">
                ...
                {/* Placeholder for author as it is not in NewsItem type yet */}
                <div className="flex justify-center items-center gap-1.5">
              ...
              <div className="flex justify-start items-start gap-2">
                <div className="p-3 bg-indigo-800 rounded-[36px] flex justify-start items-start gap-2.5 cursor-pointer hover:bg-indigo-900 transition-colors">
                  <FacebookIcon className="w-4 h-4 text-white" />
                </div>
                <div className="p-3 bg-sky-500 rounded-[36px] flex justify-start items-start gap-2.5 cursor-pointer hover:bg-sky-600 transition-colors">
                  <TwitterIcon className="w-4 h-4 text-white" />
                </div>
                <div className="p-3 bg-rose-800 rounded-[36px] flex justify-start items-start gap-2.5 cursor-pointer hover:bg-rose-900 transition-colors">
                ...
                <div className="p-2.5 bg-slate-500 rounded-[36px] flex justify-start items-start gap-2.5 cursor-pointer hover:bg-slate-600 transition-colors">
                  <LucideLink className="w-5 h-5 text-white" />
                </div>
              </div>
            </div>
          </div>
